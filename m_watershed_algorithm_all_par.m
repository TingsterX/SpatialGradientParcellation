function labels = m_watershed_algorithm_all_par(edgemetrics,minimametrics,stepnum,fracmaxh, neighbors)
% modified from Gordon2014CC 
...
for l = 1:size(labels,2)
    if rem(l, 50) == 0
        fprintf('->%d%% ', round(l/numlabels*100));
    end
